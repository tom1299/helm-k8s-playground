...
Feature: Acme challenge processing
  ...
  Scenario: Single acme challenge running
    ...
    And I forward the port 8089 of the pod "acme-challenge-dispatcher-1" to port 8089
    # TODO: Replace this step whith something like: And I wait until I can access port 8089
    ...
    Then response number 1 should have return code 404 and content "404 Not Found"
    And I stop forwarding the port 8089 of the pod "acme-challenge-dispatcher-1"
...
Scenario: No acme challenges running
    Given I forward the port 8089 of the pod "acme-challenge-dispatcher-1" to port 8089
    And I wait for 2 seconds
    When I do 1 GET request to 8089 with the following parameters:
    | url | port | host |
    | /.well-known/acme-challenge/abc | 8089 | acme-challenge-dispatcher-1.com |
